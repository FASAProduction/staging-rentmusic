        ...
        <div class="breadcrumb-wrap">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Mendaftar</li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumb End -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">    
                        ...
                        <h2>Daftar Akun</h2>
                        <br/>
                        <form action="<?php echo base_url('index.php/register/daftar'); ?>" method="POST">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" name="nama_pelanggan" type="text" placeholder="Masukkan Nama Anda">
                                </div>
                                <input type="hidden" name="alamat" value=" " />
                                <div class="col-md-6">
                                    <label>Nomor HP</label>
                                    <input class="form-control" name="no_hp" type="number" placeholder="Masukkan No HP">
                                </div>
                                <input type="hidden" name="kartu_identitas" value=" " />
                                <input type="hidden" name="no_identitas" value=" " />
                                <div class="col-md-12">
