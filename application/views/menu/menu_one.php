<div class="top-bar">
      ...
      <header class="nav-holder make-sticky">
        <div id="navbar" role="navigation" class="navbar navbar-expand-lg">
          <div class="container"><a href="index.html" class="navbar-brand home"><img src="<?php echo base_url(); ?>komponen/img/gmlogo.png" alt="Universal logo" class="d-none d-md-inline-block" width="150" height="65"></a>
