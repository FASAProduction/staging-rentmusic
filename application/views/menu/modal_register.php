              ...
              <form action="<?php echo base_url('index.php/register/pro'); ?>" method="POST">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input id="email_modal" name="username" type="text" placeholder="Username" class="form-control" required >
                        </div>
                        <div class="form-group">
                        <input id="password_modal" name="password" type="password" placeholder="password" class="form-control" required >
                        </div>
                        <div class="form-group">
                        <input id="password_modal" name="nama_pelanggan" type="text" placeholder="Nama Lengkap" class="form-control" required >
                        </div>
                        <div class="form-group">
                        <textarea id="password_modal" name="alamat" placeholder="Alamat" class="form-control" required ></textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                            <div class="form-group">
                        <input id="password_modal" name="no_hp" type="number" placeholder="Nomor HP" class="form-control" required >
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                        <input id="password_modal" name="no_identitas" type="number" placeholder="Nomor Identitas" class="form-control" required >
                        </div>
                    </div>
                </div>
                <p class="text-center">
