...
<body>
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.html"><?php echo $almus->nama_alat_musik; ?></a>
											</h4>
											...
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
                                                ...
                                                ?>
                                                <a href="<?php echo base_url('index.php/login'); ?>" class="button btn">Sewa</a>
                                                <?php }else{ ?>
												<form action="#" method="post">
													<fieldset>
														<input type="hidden" name="cmd" value="_cart" />
	...
	<!-- js-files -->
	<!-- jquery -->
	<script src="<?php echo base_url(); ?>komponen/js/jquery-2.2.3.min.js"></script>
	<!-- //jquery -->
	...
	<script src="<?php echo base_url(); ?>komponen/js/jquery.magnific-popup.js"></script>
	<script>
		$(document).ready(function () {
	...
	<!-- cart-js -->
	<script src="<?php echo base_url(); ?>komponen/js/minicart.js"></script>
	<script>
	...
	<!-- scroll seller -->
	<script src="<?php echo base_url(); ?>komponen/js/scroll.js"></script>
	<!-- //scroll seller -->

	<!-- smoothscroll -->
	<script src="<?php echo base_url(); ?>komponen/js/SmoothScroll.min.js"></script>
	<!-- //smoothscroll -->

	<!-- start-smooth-scrolling -->
	<script src="<?php echo base_url(); ?>komponen/js/move-top.js"></script>
	<script src="<?php echo base_url(); ?>komponen/js/easing.js"></script>
	<script>
	...
	<script src="<?php echo base_url(); ?>komponen/js/bootstrap.js"></script>
	<!-- //for bootstrap working -->
	<!-- //js-files -->
</body>
