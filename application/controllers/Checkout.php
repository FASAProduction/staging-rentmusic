...
class Checkout extends CI_Controller {
	...
	public function update_hari(){
		...
		$this->m_front->day_change($id_pemesanan,$jumlah_hari,$total_bayar);
		redirect('checkout');
	}
	...
	public function selesai(){
		...
		$this->m_front->proselesai($id_pemesanan,$kode_penyewaan,$id_alat_musik,$tgl_pemesanan,$tgl_jatuh_tempo,$id_pelanggan,$id_paket,$id_pegawai,$jumlah,$jumlah_hari,$jumlah_hari_telat,$denda,$total_bayar,$status_bayar,$status_sewa);
        redirect('thanks');
	}
}
