<div class="agile-main-top">
		<div class="container-fluid">
			<div class="row main-top-w3l py-2">
				<div class="col-lg-4 header-most-top">
					<p class="text-white text-lg-left text-center">Alat musik terbaik
					</p>
				</div>
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
					...
					<ul>
						<li class="text-center border-right text-white">
							<i class="fas fa-phone mr-2"></i> 081 234 567 890
						</li>
                        <?php if($this->session->userdata('masuk') == TRUE){ ?>
						<li class="text-center border-right text-white">
							<a href="#" class="text-white">
								<i class="fas fa-user-alt mr-2"></i> <?php echo $this->session->userdata('ses_nama'); ?> </a>
						</li>
						<li class="text-center text-white">
							<a href="#" data-toggle="modal" data-target="#exampleModal2" class="text-white">
								<i class="fas fa-sign-out-alt mr-2"></i> Dashboard </a>
						</li>
                        <li class="text-center text-white">
							<a href="<?php echo base_url('index.php/login/logout') ?>" class="text-white">
	...
	<!-- header-bottom-->
	<div class="header-bot" style="padding-bottom: 20px;">
		<div class="container">
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="<?php echo base_url(); ?>" class="font-weight-bold font-italic">
							<img src="<?php echo base_url(); ?>komponen/img/gmlogo.png" alt=" " width="130px" height="60px" class="logo">
						</a>
					</h1>
				</div>
				<!-- //logo -->
